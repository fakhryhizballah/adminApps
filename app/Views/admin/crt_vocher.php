                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="POST" action="Admin/addvocher">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-user  <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id=" jumlah" name="jumlah" placeholder="Jumlah X" autofocus value="<?= old('nominal'); ?>">
                                        <div class="invalid-feedback"></div>
                                        <div><?= $validation->getError('nominal'); ?></div>
                                    </div>
                                </div>
